...
void ReInit_user_sp_cpu0_dev0() {
    ...
    HIL_OutInt32(0x2000080 + _buck1_pwm_modulator__channels[0], 40000);// divide by 2 is already implemented in hw
...
void TimerCounterHandler_0_user_sp_cpu0_dev0() {
    ...
    _speed_rpm__out = XIo_InFloat(0x55000104);
    ...
    // Generated from the component: Speed1
    HIL_OutAO(0x2001, (float)_machine_3_sp_outputs_machine_3sp_outputs__out1);
    _speed1__in = _machine_3_sp_outputs_machine_3sp_outputs__out1;
    ...
    //  fprintf(f_sp_scope_debug, "\nstart = %x, index = %x, addr = %x, value = %f.", sp_scope_buff_start_addr_cpu0_er0_dev0, sp_scope_buff_index_cpuuser_sp_cpu}_cpu0_er0_dev0, sp_scope_buff_addr_cpu0_er0_dev0, _speed1__in);
    //#endif
    memcpy((X_UnInt8 *)sp_scope_buff_addr_cpu0_er0_dev0, &_speed1__in, 4);
    //printf("\n\sp_scope_buff_addr_cpu0_er0_dev0, _speed1__in 0x%x\r\n", sp_scope_buff_addr_cpu0_er0_dev0);
    //printf("\n\r addr 0x%x, value 0x%x\r\n", sp_scope_buff_addr_cpu0_er0_dev0, *(X_UnInt32*)(sp_scope_buff_addr_cpu0_er0_dev0));
    //XIo_OutInt32(sp_scope_buff_addr_cpu0_er0_dev0, _speed1__in);
    ...
    HIL_OutAO(0x2002, (float)_machine_3_sp_outputs_machine_3sp_outputs__out);
    ...
    _sum3__out = _speed_rpm__out - _to_rpm__out;
    // Generated from the component: Product6
    _product6__out = (_enable__out * _sum3__out);
    // Generated from the component: PID controller1
    _pid_controller1__pi_reg_out_int = _pid_controller1__integrator_state + 0.001 * _product6__out;
    _pid_controller1__out = _pid_controller1__pi_reg_out_int;
    // Generated from the component: Limit1
    _limit1__out = MIN(MAX(_pid_controller1__out, 0.0), 1.0);
    // Generated from the component: Buck1.PWM_Modulator
    _buck1_pwm_modulator__limited_in[0] = MIN(MAX(_limit1__out, -1.0), 1.0);
    HIL_OutInt32(0x2000040 + _buck1_pwm_modulator__channels[0], ((unsigned)((_buck1_pwm_modulator__limited_in[0] - (-1.0)) * 20000.0)));
    if (_enable__out == 0x0) {
        // pwm_modulator_en
    ...
    // Generated from the component: DC Machine1.Machine Wrapper1
    // Generated from the component: PID controller1
    _pid_controller1__integrator_state += 0.02 * _product6__out * 0.0004;
